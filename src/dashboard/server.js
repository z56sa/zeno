...
module.exports = function (app) {
    ...
    // 3. صفحة لوحة التحكم الاحترافية (ZENO V3 Ultra Dashboard)
    ...
    app.get('/dashboard/:guildId', (req, res) => {
        ...
        <body class="bg-[#060911] text-white font-['Cairo'] p-8">
            <div class="max-w-4xl mx-auto bg-[#0f1523] border border-gray-800 p-6 rounded-2xl">
                <a href="/dashboard" class="text-indigo-400 text-xs font-bold mb-4 inline-block">&rarr; العودة للوحة الرئيسية</a>
                <h1 class="text-2xl font-black mb-2">إدارة: ${targetGuild ? targetGuild.name : guildId}</h1>
                <p class="text-gray-400 text-xs mb-6">قم بتعديل إعدادات التذاكر والأوامر لهذا الخادم.</p>
                <div class="p-4 bg-indigo-500/10 border border-indigo-500/20 rounded-xl text-indigo-300 text-xs">
                    جاري تحميل إعدادات السيرفر...
                </div>
            </div>
        </body>
        </html>
