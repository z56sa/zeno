...
* We **never** read, log, or store your private messages (DMs) or general server chat history.
* We **never** collect passwords, payment information, or personal identifying data.
* We **never** sell, rent, or trade any user or guild data to third parties.

### 3. Data Storage & Security
All data is stored securely in an encrypted local database. Access is strictly limited to bot operational services.
